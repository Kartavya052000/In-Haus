...
const TaskCalendar = ({ markedDates, activities, themeColors }) => {
  ...
  const [isCalendarOpen, setIsCalendarOpen] = useState(true); // Estado para manejar si el calendario está abierto o cerrado
